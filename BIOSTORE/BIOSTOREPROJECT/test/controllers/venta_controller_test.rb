...
class VentaControllerTest < ActionController::TestCase
  ...
  test "should create ventum" do
    assert_difference('Ventum.count') do
      post :create, ventum: { cantidad_productos: @ventum.cantidad_productos, cliente_id: @ventum.cliente_id, empleado_id: @ventum.empleado_id, fecha: @ventum.fecha }
    end
  ...
  test "should update ventum" do
    patch :update, id: @ventum, ventum: { cantidad_productos: @ventum.cantidad_productos, cliente_id: @ventum.cliente_id, empleado_id: @ventum.empleado_id, fecha: @ventum.fecha }
    assert_redirected_to ventum_path(assigns(:ventum))
  end
