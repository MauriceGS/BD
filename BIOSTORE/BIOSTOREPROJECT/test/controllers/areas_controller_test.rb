...
class AreasControllerTest < ActionController::TestCase
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post :create, area: { descripcion: @area.descripcion, nombre: @area.nombre, total_empleados: @area.total_empleados }
    end
  ...
  test "should update area" do
    patch :update, id: @area, area: { descripcion: @area.descripcion, nombre: @area.nombre, total_empleados: @area.total_empleados }
    assert_redirected_to area_path(assigns(:area))
  end
