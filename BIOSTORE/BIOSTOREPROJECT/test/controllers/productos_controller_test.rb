...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { cantidad: @producto.cantidad, marca: @producto.marca, nombre: @producto.nombre, precio: @producto.precio, proveedor_id: @producto.proveedor_id, tipo: @producto.tipo }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { cantidad: @producto.cantidad, marca: @producto.marca, nombre: @producto.nombre, precio: @producto.precio, proveedor_id: @producto.proveedor_id, tipo: @producto.tipo }
    assert_redirected_to producto_path(assigns(:producto))
  end
