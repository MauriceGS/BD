...
class EmpleadosControllerTest < ActionController::TestCase
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post :create, empleado: { area_id: @empleado.area_id, direccion: @empleado.direccion, email: @empleado.email, nombre: @empleado.nombre, sueldo: @empleado.sueldo }
    end
  ...
  test "should update empleado" do
    patch :update, id: @empleado, empleado: { area_id: @empleado.area_id, direccion: @empleado.direccion, email: @empleado.email, nombre: @empleado.nombre, sueldo: @empleado.sueldo }
    assert_redirected_to empleado_path(assigns(:empleado))
  end
